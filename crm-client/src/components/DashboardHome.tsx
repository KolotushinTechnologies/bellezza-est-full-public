...
export default function DashboardHome({ services, portfolio, careArticles, blogPosts, clients, appointments }: DashboardHomeProps) {
  const stats = [
    {
      label: "Услуги",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            {appointments.slice(0, 5).map((appointment) => {
              ...
              return (
                ...
                >
                  <div>
                    <p style={{ fontWeight: "600", marginBottom: "0.25rem" }}>{client?.name || 'Неизвестно'}</p>
