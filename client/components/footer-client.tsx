...
import { FooterContactSkeleton } from "./skeletons/contact-skeleton"
            ...
            <div>
              ...
              {loading ? (
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  <p>{contact.address}</p>
                  <a href={`tel:${contact.phone.replace(/\s/g, '')}`} className="block hover:text-foreground transition-colors">
                    {contact.phone}
                  </a>
                  <a
